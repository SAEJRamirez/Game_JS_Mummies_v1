...
//Classe qui représente le modèle de notre ennemi Wormy. Elle étend de Sprite afin de pouvoir l'animer
export class Wormy extends Sprite {
    //Méthode qui définit les paramètres de notre ennemi lors de son instanciation
    constructor({position, imgSrc = "../Images/enemies/wormy/leftWalk.png", frameRate = 40, scale = 0.5, distance}) {
        ...
        this.animations = {
            walk: {
                imgSrc: "../Images/enemies/wormy/leftWalk.png",
                frameRate: 40,
                frameBuffer: 3
            },
            leftWalk: {
                imgSrc: "../Images/enemies/wormy/walk.png",
                frameRate: 40,
                frameBuffer: 3
            },
        }
