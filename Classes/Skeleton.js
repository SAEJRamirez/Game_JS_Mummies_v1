...
export class Skeleton extends Sprite{
    ...
    constructor({position, imgSrc = "../Images/enemies/skeleton/leftWalk.png", frameRate = 22, scale = 0.4, distance}) {
        ...
        this.animations = {
            walk: {
                imgSrc: "../Images/enemies/skeleton/leftWalk.png",
                frameRate: 22,
                frameBuffer: 3
            },
            leftWalk: {
                imgSrc: "../Images/enemies/skeleton/walk.png",
                frameRate: 22,
                frameBuffer: 3
            },
        }
